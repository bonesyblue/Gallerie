...
extension AppDelegate: UIApplicationDelegate {
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        executeRemoteMethod("onWillResignActive", completion: { (_: Bool) in
            // ...
        })
    }
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        executeRemoteMethod("onDidEnterBackground", completion: { (_: Bool) in
            // ...
        })
    }
    ...
    func applicationWillEnterForeground(_ application: UIApplication) {
        ...
        executeRemoteMethod("onWillEnterForeground", completion: { (_: Bool) in
            // ...
        })
    }
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        executeRemoteMethod("onDidBecomeActive", completion: { (_: Bool) in
            // ...
        })
    }
}
