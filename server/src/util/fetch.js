 ...
 *
 * @example
 * ajax('http://api.mymovieapp.com/movies')
 ...
 */
const ajax = (url, options, method = "GET") => {
 ...
 *
 * @example
 * Ajax.get('http://api.mymovieapp.com/movies')
 *         .then((response) => // do something with the response)
 *         .catch((error) => // catch errors )
 *
 * @param  {string} url                         Resource url
 ...
 * @return {Promise}                            The Promise that resolves on ajax success
 */
 get: (url, options) => ajax(url, options, "GET"),
 /**
  ...
  * @return {Promise}                            The Promise that resolves on ajax success
  */
 post: (url, options) => ajax(url, options, "POST"),
 /**
  ...
  * @return {Promise}                            The Promise that resolves on ajax success
  */
put: (url, options) => ajax(url, options, "PUT"),
 /**
  ...
  * @return {Promise}                            The Promise that resolves on ajax success
  */
 del: (url, options) => ajax(url, options, "DELETE"),
